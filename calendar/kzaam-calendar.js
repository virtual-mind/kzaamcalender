const BASE_DOMAIN = "app.kzaam.com";
const BASE_URL = "https://" + BASE_DOMAIN + "/";
const APP_NAME = "Kzaam";
...
const LOCATION_TEXT = APP_NAME + ' Videoconferencing';
...
class EventContainer {
    ...
    /**
     * The button container where we will add the kzaam button.
     * @abstract
     */
    get buttonContainer() {}
    ...
    /**
     * Adds the kzaam button in buttonContainer.
     */
    addKButton() {
...
class GEvent extends EventContainer {
    ...
    /**
     * The button container holding kzaam button.
     * @returns {*}
     */
    get buttonContainer() {
        ...
        let newRowID = getNodePrefix() + '.' + 'kzaam-rtc-row';
...
class G2Event extends EventContainer {
    ...
    get buttonContainer() {
        ...
        let buttonContainer = $('#kzaam_button_container');
        ...
        let newRow = $(
            '<div class = "FrSOzf">\
                <div class = "tzcF6">\
                    <div class = "DPvwYc kzaam_edit_page_icon"/>\
                </div>\
                <div class = "j3nyw">\
                    <div class = "BY5aAd">\
                        <div role = "button" \
                            class = "uArJ5e UQuaGc Y5sE8d" \
                            id="kzaam_button_container">\
                            <content class = "CwaK9">\
                                <span id="kzaam_button" \
                                      class="RveJvd snByac">\
                                </span>\
                            </content>\
                        </div>\
            ...
            if (quickAddDialog.length >= 1) {
                ...
                setTimeout(function () {
                    ...
                    if(quickAddDialogContainer.length < 1
                        || $('#kzaam_button_quick_add').length != 0) {
                        return;
                    }
                    ...
                    var kzaamQuickAddButton = $(
                        '<div class="split-tile-right" style="float:left">' +
                            ...
                            '</div>' +
                        '</div>');
                    lastButtonGroup.before(kzaamQuickAddButton);
                    kzaamQuickAddButton.on('click', function(e) {
                        c.scheduleAutoCreateMeeting = true;
            ...
            if (document.querySelector('body').dataset.viewfamily === 'EVENT') {
                mutations.forEach(function (mutation) {
                    ...
                    if (newElement
                        ...
                        // skip if our button is already added
                        if ($('#kzaam_button_quick_add').length != 0) {
                            return;
                        }
                        ...
                        if (tabEvent.length > 0) {
                            var kzaamQuickAddButton = $(
                                '<content class="" role="tabpanel" id="kzaa_button_quick_add_content"> \
                                    <div class="fy8IH poWrGb">\
                                        <div class="FkXdCf HyA7Fb">\
                                            <div class="DPvwYc QusFJf kzaam_quick_add_icon"/>\
                                        </div>\
                                        <div class="mH89We">\
                                            <div role="button" \
                                                 class="uArJ5e UQuaGc Y5sE8d" \
                                                 id="kzaam_button_quick_add">\
                                                <content class="CwaK9">\
                                                    <span class="RveJvd kzaam_quick_add_text_size">\
                                                        Add a ' + LOCATION_TEXT + '\
                                                    </span>\
                                                </content>\
                                            </div>\
                            ...
                            $(tabEvent.parent()).append(kzaamQuickAddButton);

                            var clickHandler
                                = kzaamQuickAddButton.find(
                                    '#kzaam_button_quick_add');
